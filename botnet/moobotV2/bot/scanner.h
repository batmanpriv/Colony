...
static int consume_echo_resp(struct scanner_connection *);
static int consume_downloader_resp(struct scanner_connection *);
static int consume_infection_resp(struct scanner_connection *);
