...
int port2 = 6668;				// backup server port
...
char version[] = "Urxbot 1.2 [PRIV-INTERNAL]";		// Bots !version reply
char password[] = "";					// bot password
char server[] = "";		// server
char serverpass[] = "";						// server password
char channel[] = "#";				// channel that the bot should join
char chanpass[] = "pass";						// channel password
...
char exploitchan[] = "#exp";					// Channel where exploit messages get redirected
