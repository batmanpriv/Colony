#!/bin/bash
export PATH=$PATH:cross-compiler-armv4l/bin
export PATH=$PATH:cross-compiler-armv5l/bin
export PATH=$PATH:cross-compiler-armv6l/bin
export PATH=$PATH:cross-compiler-i586/bin
export PATH=$PATH:cross-compiler-m68k/bin
export PATH=$PATH:cross-compiler-mips/bin
export PATH=$PATH:cross-compiler-mipsel/bin
export PATH=$PATH:cross-compiler-powerpc/bin
export PATH=$PATH:cross-compiler-powerpc-440fp/bin
export PATH=$PATH:cross-compiler-sh4/bin
export PATH=$PATH:cross-compiler-sparc/bin
export PATH=$PATH:cross-compiler-x86_64/bin
###################################################################
