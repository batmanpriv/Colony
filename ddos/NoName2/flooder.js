...
if (!reqmethod || !target || !time || !ratelimit) {
    console.clear();
    console.error(`
    VUESO v2.0 (Main Version) Method With RST STREAM (CVE-2023-44487) // Updated: 16.03.2024
    How to use & example:
    Options:
...
if (isNaN(ratelimit) || ratelimit <= 0 || ratelimit > 1000) {
    console.error(`Error ratelimit can not high 1000`)
    process.exit(1);
}
